...
function searchOrder() {
  ...
  setTimeout(() => {
    ...
    if (customerOrders.length > 0) {
        ...
        orderSummaryItem.innerHTML = `
                    ...
                    <div class="order-detail" id="orderDetail-${index}">
                        ...
                        <div class="info-section">
                            ...
                            <p><strong>Số điện thoại:</strong> <a href="tel:${
                              order.senderPhone
                            }">${order.senderPhone}</a></p>
                        </div>
                        <h3>Người nhận</h3>
                        <div class="info-section">
                        ...
                        <div class="info-section">
                            ...
                            <p><strong>Số điện thoại:</strong> <a href="tel:${
                              order.vehicle.phone
                            }">${order.vehicle.phone}</a></p>
                        </div>
                        <h3>Thông tin tuyến đường</h3>
                        <div class="info-section">
                            <p><strong>Xuất phát:</strong> ${
                              order.route.startLocation
                            } (Giờ: ${order.route.startTime})</p>
                            <p><strong>Điểm cuối:</strong> ${
                              order.route.endLocation
                            } (Giờ dự kiến: ${order.route.endTime})</p>
                        </div>
                    </div>
                `;
      ...
      preloader.style.display = "none";
      orderSummaryDiv.innerHTML =
        "<p>Không tìm thấy đơn hàng với số điện thoại này.</p>";
    }
  ...
  setTimeout(() => {
    ...
    orderDetails.forEach((detail, idx) => {
      if (index === idx) {
        ...
        const button =
          detail.previousElementSibling.querySelector(".toggle-button");
